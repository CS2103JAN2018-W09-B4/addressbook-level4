...
public class TypicalCards {
    ...
    public static final Card CS2103T_CARD = new CardBuilder().withFront(VALID_FRONT_CS2103T_CARD).withBack(VALID_BACK_CS2103T_CARD)
            .build();
    public static final Card CS2101_CARD = new CardBuilder().withFront(VALID_FRONT_CS2101_CARD).withBack(VALID_BACK_CS2101_CARD)
            .build();
