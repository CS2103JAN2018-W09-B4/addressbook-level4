...
public class AddCommandSystemTest extends AddressBookSystemTest {
    ...
    public void add() throws Exception {
        ...
        toAdd = new TagBuilder().withName(VALID_NAME_BOB).withPhone(VALID_PHONE_AMY)
        ...
        toAdd = new TagBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_BOB)
                .withAddress(VALID_ADDRESS_AMY).build();
        command = AddCommand.COMMAND_WORD + NAME_DESC_AMY + PHONE_DESC_BOB + ADDRESS_DESC_AMY;
        assertCommandSuccess(command, toAdd);

        /* Case: add a tag with all fields same as another tag in the address book except address -> added */
        toAdd = new TagBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_AMY)
                .withAddress(VALID_ADDRESS_BOB).build();
        command = AddCommand.COMMAND_WORD + NAME_DESC_AMY + PHONE_DESC_AMY + ADDRESS_DESC_BOB;
        assertCommandSuccess(command, toAdd);
