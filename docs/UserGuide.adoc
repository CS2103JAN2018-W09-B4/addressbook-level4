...
Show flashcards that are due for review by a certain date
...
* suppose you wanna view cards due before the date 28/04/2018, you can just do `showdue` d/28 m/04 y/2018.
* suppose today is 13/04/2018, you want to view cards due before the date 28/04/2018, you can do `showdue` d/28 the options that you have not entered will be automatically assumed to be the current month and year.
****
...
* `showdue d/28` +
Suppose to day is 13/04/2018, `m/04 y/2018` are automatically assumed to be the current month.

==== Answering flashcards: `answer`
After clicking and selecting a flashcard. Answer to give feedback to the scheduling algorithm to schedule the cards for future review.

Format: `answer c/CONFIDENCE`

****
* The confidence can only be 0, 1, 2.
* Card must be selected first before answering
** To select a card either click on it
** Then `answer c/CONFIDENCE`
****
...
==== Manually schedule card for a date: `schedule`
Manually schedule cards to be reviewed on a date in the future.

Format: `schedule  d/DAY m/MONTH y/YEAR`

****
* schedule can be used without any options, this will just schedule the flashcard for today
* suppose you want to schedule cards for review on the date 28/04/2018, you can just do `schedule d/28 m/04 y/2018`.
* suppose today is 13/04/2018,
you want to schedule card for review on the date 28/04/2018, you can do `showdue` d/28 the options that you have not entered will be automatically assumed to be the current month and year.
****
...
Show cards due before 28/04/2018
* `schedule d/28` +
Suppose today is 13/04/2018, `m/04 y/2018` are automatically assumed to be the current month.
