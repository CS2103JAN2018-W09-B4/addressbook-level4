...
Although Flashy was built for the language learner in mind, it should prove useful for any student, as as new studying tool in their arsenal.
...
* Parameters can be specified be in any order. In this example, `addc f/front b/back` and `addc b/back f/front` are
equivalent.
